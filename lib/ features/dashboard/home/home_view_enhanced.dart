...
/// Home View - Enhanced with Welcome Card, Stats, and Quick Actions
/// Displays user's recent notes with summary
class HomeView extends StatelessWidget {
  ...
  /// Get stats stream for all categories
  Stream<Map<String, int>> _getStatsStream(String userId) async* {
    ...
    await for (final notesSnapshot in notesStream) {
      final tasksSnapshot = await tasksStream.first;
